...
│   ├── events/                         # family A: KOTH/Citadel; conquest/; king/ (Kill the King); core/ (DTC, Last Break); slide/ (Slide); totem/ (Totem, Mini Totem); setup/ (/events create..delete, every kind)
