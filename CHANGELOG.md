...
- **Event waypoints are put 60 blocks above the event** (`apollo.yml`, `waypoints.event-height`): a beam starting on the floor of a zone is lost behind the landscape from any distance. The King's waypoint follows the player and is never raised.
