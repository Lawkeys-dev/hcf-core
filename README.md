...
| **Kits and items** | Kits saved from an inventory, refill signs, a layout editor, 43 partner items built in (Switcher, Ninja, Rage Ball, Pocket Bard, Grappling Hook…) and your own, killstreak rewards, custom enchants, effect commands (`/speed`, `/strength`…), enchantment, potion and effect caps, block limits per claim, a crowbar |
...
- **Rules are plain Java.** Every rule engine is free of the server API and unit-tested — 1038 tests, including real SQLite round trips.
