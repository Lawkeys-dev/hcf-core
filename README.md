...
| **Combat** | Deathbans with rank tiers, combat tag and combat logging, safe zones, friendly fire rules, loot protection, strength nerf — and a **classic 1.7.10 combat** mode: no attack cooldown, sword blocking, 1.7 knockback, regeneration, golden apples and pots |
...
- **Rules are plain Java.** Every rule engine is free of the server API and unit-tested — 989 tests, including real SQLite round trips.
