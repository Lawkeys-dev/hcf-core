...
| **Kits and items** | Kits saved from an inventory, refill signs, a layout editor, 21 partner items built in (Switcher, Ninja, Rage Ball, Pocket Bard, Samurai…) and your own, killstreak rewards, custom enchants, effect commands (`/speed`, `/strength`…), enchantment, potion and effect caps, block limits per claim, a crowbar |
