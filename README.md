...
| **Events** | KOTH, Citadel (fought in a claimed Citadel with no pearls or partner items), Conquest, Kill the King, DTC, Last Break, Slide, Totem and Mini Totem on daily schedules, with a hologram above every zone; Mountains that refill on a clock |
