...
-   :material-treasure-chest:{ .lg .middle } __Kits and items__
    ...
    Kits built from an inventory, refill signs, a layout editor and partner items. Custom enchants, effect commands such as `/speed`, enchantment, potion and effect caps, block limits per claim, and a crowbar for End portal frames.
