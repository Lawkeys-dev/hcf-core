 ...
 */
public record AbilitySettings(boolean enabled, long globalCooldownSeconds, String menuTitle,
    ...
    public static AbilitySettings defaults() {
        return new AbilitySettings(true, 10, "&dAbilities", new DisabledIn(true, true, true, true, false),
