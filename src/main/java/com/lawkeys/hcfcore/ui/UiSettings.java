                ...
                new TablistRules(true, com.lawkeys.hcfcore.ui.tab.TabStyle.AUTO, 20L,
                        new GridRules(
                                ...
                                List.of(
                                        ...
                                        List.of("", "[head:MHF_Question]{primary}&lServer", "{text}Online {dark}{bullet} {secondary}%online%", "{text}Ping {dark}{bullet} {secondary}%ping%ms", "", "[head:MHF_Exclamation]{primary}&lEvents", "%no_event_line%", "%phase_line%", "%event_line%", "%king_line%", "%conquest_line%", "%dtc_line%", "%last_break_line%", "%slide_line%", "%totem_line%", "%timer_1%", "%timer_2%", "%timer_3%"),
